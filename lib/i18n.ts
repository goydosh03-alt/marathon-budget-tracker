...
export const STRINGS = {
  ...
  "nav.budget": { uk: "Бюджет", en: "Budget", ru: "Бюджет" },

  // фіча «Бюджет»
  "budget.title": { uk: "Бюджети", en: "Budgets", ru: "Бюджеты" },
  "budget.emptyTitle": { uk: "Ще немає бюджетів", en: "No budgets yet", ru: "Пока нет бюджетов" },
  "budget.emptyHint": { uk: "Створи свій перший бюджет", en: "Create your first budget", ru: "Создай свой первый бюджет" },
  "budget.spent": { uk: "Витрачено", en: "Spent", ru: "Потрачено" },
  "budget.overspent": { uk: "Перевитрата", en: "Overspent", ru: "Перерасход" },
  "budget.overspentWord": { uk: "перевитрачено", en: "overspent", ru: "перерасход" },
  "budget.left": { uk: "Залишилось", en: "Left", ru: "Осталось" },
  "budget.thisDay": { uk: "сьогодні", en: "today", ru: "сегодня" },
  "budget.thisWeek": { uk: "цього тижня", en: "this week", ru: "на этой неделе" },
  "budget.thisMonth": { uk: "цього місяця", en: "this month", ru: "в этом месяце" },
  "budget.leftEachDay": { uk: "на день", en: "each day", ru: "в день" },
  "budget.daysLeft": { uk: "дн. лишилось", en: "days left", ru: "дн. осталось" },
  "budget.periodDay": { uk: "День", en: "Daily", ru: "День" },
  "budget.periodWeek": { uk: "Тиждень", en: "Weekly", ru: "Неделя" },
  "budget.periodMonth": { uk: "Місяць", en: "Monthly", ru: "Месяц" },
  "budget.type": { uk: "Тип бюджету", en: "Budget type", ru: "Тип бюджета" },
  "budget.typeDesc": { uk: "Загальний рахує всі витрати разом, а бюджет по категорії стежить лише за витратами обраного типу.", en: "The overall budget tracks all expenses together, while a category budget follows only expenses of that type.", ru: "Общий считает все расходы вместе, а бюджет по категории следит только за расходами выбранного типа." },
  "budget.typeOverall": { uk: "Загальний бюджет", en: "Overall Budget", ru: "Общий бюджет" },
  "budget.typeCategory": { uk: "По категорії", en: "Category Budget", ru: "По категории" },
  "budget.chooseCategory": { uk: "Оберіть категорію", en: "Choose a category", ru: "Выберите категорию" },
  "budget.timeframe": { uk: "Оберіть період", en: "Choose a time frame", ru: "Выберите период" },
  "budget.timeframeDesc": { uk: "Бюджет оновлюватиметься щоразу з початком нового періоду.", en: "The budget refreshes at the start of each new period.", ru: "Бюджет обновляется в начале каждого нового периода." },
  "budget.startWeek": { uk: "З якого дня тижня", en: "Pick a start day", ru: "С какого дня недели" },
  "budget.startMonth": { uk: "З якого числа", en: "Pick a start date", ru: "С какого числа" },
  "budget.startDesc": { uk: "З цього дня рахуватиметься період.", en: "The period is counted from this day.", ru: "С этого дня считается период." },
  "budget.startDayTitle": { uk: "Готово до суми", en: "Ready for the amount", ru: "Готово к сумме" },
  "budget.startDayDesc": { uk: "Денний бюджет починається щодня зранку.", en: "A daily budget starts fresh every morning.", ru: "Дневной бюджет начинается каждое утро." },
  "budget.startTapContinue": { uk: "Натисни «Продовжити», щоб задати суму.", en: "Tap Continue to set the amount.", ru: "Нажми «Продолжить», чтобы задать сумму." },
  "budget.amountTitle": { uk: "Сума бюджету", en: "Set budget amount", ru: "Сумма бюджета" },
  "budget.amountDesc": { uk: "Спробуй лишатися в межах цього ліміту. Змінити зможеш будь-коли.", en: "Try to stay under this limit. You can change it anytime.", ru: "Старайся оставаться в пределах лимита. Изменить можно в любой момент." },
  "budget.amountPerDay": { uk: "/день", en: "/day", ru: "/день" },
  "budget.create": { uk: "Створити бюджет", en: "Create budget", ru: "Создать бюджет" },
  "budget.continue": { uk: "Продовжити", en: "Continue", ru: "Продолжить" },
  "budget.noExpenses": { uk: "Ще немає витрат у цьому періоді. Додай витрату через +, і сума відніметься від бюджету.", en: "No expenses in this period yet. Add an expense with +, and it will subtract from the budget.", ru: "Пока нет расходов в этом периоде. Добавь расход через +, и он вычтется из бюджета." },
  "budget.today": { uk: "Сьогодні", en: "Today", ru: "Сегодня" },
  "budget.budgetWord": { uk: "Бюджет", en: "Budget", ru: "Бюджет" },
  "budget.overallProgress": { uk: "Загальний прогрес", en: "Overall progress", ru: "Общий прогресс" },
  "budget.spendingByCategory": { uk: "Витрати за категоріями", en: "Spending by category", ru: "Расходы по категориям" },
  "budget.transactions": { uk: "Транзакції", en: "Transactions", ru: "Транзакции" },
  "budget.addExpense": { uk: "Додати витрату", en: "Add expense", ru: "Добавить расход" },
  "budget.createBudget": { uk: "Створити бюджет", en: "Create a budget", ru: "Создать бюджет" },
  "budget.categoryBudgets": { uk: "Бюджети за категоріями", en: "Category budgets", ru: "Бюджеты по категориям" },
  "budget.categoryBudgetsDesc": { uk: "Задай ліміт для окремої категорії і стеж за витратами тут", en: "Set a limit for a specific category and track its spending here", ru: "Задай лимит для отдельной категории и следи за расходами здесь" },
  "budget.addCategory": { uk: "Бюджет категорії", en: "Category budget", ru: "Бюджет категории" },
  "budget.addAnotherCategory": { uk: "Додати ще категорію", en: "Add another category", ru: "Добавить ещё категорию" },
  "budget.overBy": { uk: "перевитрата на", en: "over by", ru: "перерасход на" },
  "budget.added": { uk: "Додано", en: "Added", ru: "Добавлено" },
  "budget.allocateTitle": { uk: "Розподіл бюджету", en: "Allocate budget", ru: "Распределение бюджета" },
  "budget.allocateShare": { uk: "Потягни, щоб задати частку з", en: "Drag to set the share of your", ru: "Потяни, чтобы задать долю из" },
  "budget.leftToAllocate": { uk: "лишилось розподілити", en: "left to allocate", ru: "осталось распределить" },
  "budget.mon": { uk: "Пн", en: "Mon", ru: "Пн" },
  "budget.tue": { uk: "Вт", en: "Tue", ru: "Вт" },
  "budget.wed": { uk: "Ср", en: "Wed", ru: "Ср" },
  "budget.thu": { uk: "Чт", en: "Thu", ru: "Чт" },
  "budget.fri": { uk: "Пт", en: "Fri", ru: "Пт" },
  "budget.sat": { uk: "Сб", en: "Sat", ru: "Сб" },
  "budget.sun": { uk: "Нд", en: "Sun", ru: "Вс" },
